        ...
        <div className="container wow fadeInUp">
          ...
          <div className="row pm-none">
            <div className="col-lg-4 col-md-6 col-sm-6">
              <div className="single-item text-center">
                <div className="img-area">
                  <img src="./assets/images/icons/features-icon-1.png" alt="not found" />
                </div>
            ...
            <div className="col-lg-4 col-md-6 col-sm-6">
              <div className="single-item text-center">
                <div className="img-area">
                  <img src="./assets/images/icons/features-icon-2.png" alt="not found" />
                </div>
            ...
            <div className="col-lg-4 col-md-6 col-sm-6">
              <div className="single-item text-center">
                <div className="img-area">
                  <img src="./assets/images/icons/features-icon-3.png" alt="not found" />
                </div>
            ...
            <div className="col-lg-4 col-md-6 col-sm-6">
              <div className="single-item text-center">
                <div className="img-area">
                  <img src="./assets/images/icons/features-icon-4.png" alt="not found" />
                </div>
                <h5>Make 2x your $$</h5>
                <p>Our dedicated admins are there to answer in no time, avg response time is 5mins.</p>
              </div>
            ...
            <div className="col-lg-4 col-md-6 col-sm-6">
              <div className="single-item text-center">
                <div className="img-area">
                  <img src="./assets/images/icons/features-icon-5.png" alt="not found" />
                </div>
            ...
            <div className="col-lg-4 col-md-6 col-sm-6">
              <div className="single-item text-center">
                <div className="img-area">
                  <img src="./assets/images/icons/features-icon-6.png" alt="not found" />
                </div>
